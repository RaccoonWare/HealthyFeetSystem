...
<div class="container">
    <div class="row m-y-2">
        <div class="col-lg-3"><center>
            <img src="dist/img/user2-160x160.jpg" class="m-x-auto img-fluid img-circle" alt="avatar">
            <h4 class="m-t-2">{{user.name}}</h4>
        ...
        <div class="col-lg-8 push-lg-4">
            ...
            <div class="tab-content p-b-3">
                ...
                <div class="tab-pane" id="edit"><br><br>
                    ...
                    <form role="form">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label form-control-label"></label>
                            <div class="col-lg-9">
                                <input type="reset" class="btn btn-secondary" value="Cancel" @click="menu=4">
